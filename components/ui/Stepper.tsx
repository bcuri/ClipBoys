    ...
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: 'var(--brand-green)', color: 'var(--brand-green)' },
          complete: { scale: 1, backgroundColor: 'var(--brand-green)', color: '#3b82f6' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: 'var(--brand-green)' }
  };
