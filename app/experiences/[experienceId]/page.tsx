				...
				<div className="relative min-h-screen w-full bg-black pt-0 mt-0">
                    ...
                    {activeClipIndex !== null && videoData?.videoId && (
                        (() => {
                            ...
                            const embedUrl = `https://www.youtube.com/embed/${vid}?start=${start}&end=${end}&autoplay=1&controls=0&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3&playsinline=1&loop=1&playlist=${vid}&fs=0&disablekb=1`;
                            return (
